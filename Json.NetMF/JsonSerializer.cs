            ...
            if (type.IsClass)
            {
                ...
                foreach (FieldInfo field in fields)
                {
                    ...
                    foreach (var attribute in attributes)
                    {
                        ...
                        {                            
                            customAttributeName = (attribute as JsonPropertyNameAttribute).Name;
                            break;
                        }
                    ...
                    if (ignoreSerialization) break;

                    object obj = field.GetValue(o);
                
                    if (customAttributeName != "")
                    {
                        hashtable.Add(customAttributeName, obj);
                    }
                    else
                    {
                        hashtable.Add(field.Name, obj);
                    }
                }
